...
plt.plot(Height, f_cl)              # PLOTTING AVERAGED RESULTS
plt.xlabel('Height (Rc)')
plt.ylabel('clumping factor')
plt.title('Clumping factor Averaged')
plt.figure()
plt.plot(Height_flattened_per5, fcl_flattened_per5)              # PLOTTING AVERAGED RESULTS
plt.xlabel('Height (Rc)')
plt.ylabel('clumping factor')
plt.title('Clumping factor Averaged flattened per 5 cells')
plt.figure()
plt.plot(Height_flattened_per10, fcl_flattened_per10)              # PLOTTING AVERAGED RESULTS
plt.xlabel('Height (Rc)')
plt.ylabel('clumping factor')
plt.title('Clumping factor Averaged flattened per 10 cells')
plt.figure()
plt.plot(Height_flattened_per15, fcl_flattened_per15)              # PLOTTING AVERAGED RESULTS
plt.xlabel('Height (Rc)')
plt.ylabel('clumping factor')
plt.title('Clumping factor Averaged flattened per 15 cells')
plt.figure()
plt.plot(Height_flattened_per20, fcl_flattened_per20)              # PLOTTING AVERAGED RESULTS
plt.xlabel('Height (Rc)')
plt.ylabel('clumping factor')
plt.title('Clumping factor Averaged flattened per 20 cells')
plt.figure()
plt.plot(Height_flattened_per50, fcl_flattened_per50)              # PLOTTING AVERAGED RESULTS
plt.xlabel('Height (Rc)')
plt.ylabel('clumping factor')
plt.title('Clumping factor Averaged flattened per 50 cells')
plt.show()
