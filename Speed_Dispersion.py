...
plt.plot(Height, v_r_disp, color="b", label="no rotation")  # AVERAGED RESULT
plt.xlabel('Height (Rc)')
plt.ylabel('dispersion (1000 km/s)')
plt.title("radial velocity dispersion")
plt.legend(loc="upper right")
plt.savefig('vr_disp.png', bbox_inches='tight')
plt.show()

plt.rcParams['font.size'] = 16
plt.plot(Height, v_t_disp, color="b", label="no rotation")  # AVERAGED RESULT
plt.xlabel('Height (Rc)')
plt.ylabel('dispersion (1000 km/s)')
plt.title("lateral velocity dispersion")
plt.legend(loc="upper right")
plt.savefig('vt_disp.png', bbox_inches='tight')
plt.show()

plt.rcParams['font.size'] = 16
plt.plot(Height, v_t_RMS, color="b", label="no rotation")
plt.xlabel('Height (Rc)')
plt.ylabel('RMS (1000 km/s)')
plt.title("lateral RMS")
plt.legend(loc="upper right")
plt.savefig('vt_RMS.png', bbox_inches='tight')
plt.show()
